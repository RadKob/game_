...
@onready var rewards_button: Button = %Rewards
@onready var shop_button: Button = %Shop
@onready var treasure_button: Button = %Treasure
...
func _setup_event_connect() -> void:
...
func _on_battle_won() -> void:
	...
	reward_scene.add_gold_reward(map.last_room.battle_stats.rool_gold_reward())
