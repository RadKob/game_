...
func _setup_card_chances() -> void:
	card_reward_total_weight = run_stats.common_weight + run_stats.rare_weight + run_stats.epic_weight
	card_rarity_weights [Card.Rarity.COMMON] = run_stats.common_weight
	card_rarity_weights [Card.Rarity.RARE] = run_stats.rare_weight + run_stats.rare_weight
	card_rarity_weights [Card.Rarity.EPIC] = card_reward_total_weight
